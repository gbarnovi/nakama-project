...
// LeaderboardList provides a mock function with given fields: categoryStart, categoryEnd, limit, cursor
func (_m *NakamaModule) LeaderboardList(categoryStart int, categoryEnd int, limit int, cursor string) (*api.LeaderboardList, error) {
	ret := _m.Called(categoryStart, categoryEnd, limit, cursor)

	var r0 *api.LeaderboardList
	var r1 error
	if rf, ok := ret.Get(0).(func(int, int, int, string) (*api.LeaderboardList, error)); ok {
		return rf(categoryStart, categoryEnd, limit, cursor)
	}
	if rf, ok := ret.Get(0).(func(int, int, int, string) *api.LeaderboardList); ok {
		r0 = rf(categoryStart, categoryEnd, limit, cursor)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(int, int, int, string) error); ok {
		r1 = rf(categoryStart, categoryEnd, limit, cursor)
	} else {
		r1 = ret.Error(1)
	}
...
// StorageList provides a mock function with given fields: ctx, userID, collection, limit, cursor
func (_m *NakamaModule) StorageList(ctx context.Context, userID string, collection string, limit int, cursor string) ([]*api.StorageObject, string, error) {
	ret := _m.Called(ctx, userID, collection, limit, cursor)

	var r0 []*api.StorageObject
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, string) ([]*api.StorageObject, string, error)); ok {
		return rf(ctx, userID, collection, limit, cursor)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, string) []*api.StorageObject); ok {
		r0 = rf(ctx, userID, collection, limit, cursor)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, int, string) string); ok {
		r1 = rf(ctx, userID, collection, limit, cursor)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(context.Context, string, string, int, string) error); ok {
		r2 = rf(ctx, userID, collection, limit, cursor)
	} else {
		r2 = ret.Error(2)
	}
